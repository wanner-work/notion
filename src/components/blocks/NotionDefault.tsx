...
export default function NotionDefault({ block }: NotionBlockObject) {
  return (
    <div className="bg-amber-300/20 p-5 mt-5 text-amber-300 font-mono rounded">
      ...
      <p className="text-sm">
        See <a className="underline" href="https://github.com/wanner-work/notion?tab=readme-ov-file#customizing-the-rendering-of-the-blocks" target="_blank">https://github.com/wanner-work/notion?tab=readme-ov-file#customizing-the-rendering-of-the-blocks</a> for more information on how to
